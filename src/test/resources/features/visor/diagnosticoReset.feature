...
Feature: Como usuario deseo ingresar a la pagina principal de Visor
  ...
  @ResetTotalNumeroActivo @VISO-3236 @VISOR_PILOTO
  ...
  @ResetTotalNumeroSuspendido @VISO-3236 @VISOR_PILOTO
  ...
  @ResetDatosNumeroActivo @VISO-3236 @VISOR_PILOTO
  ...
  @ResetDatosNumeroSuspendido @VISO-3236 @VISOR_PILOTO
  ...
  @ResetVozlNumeroActivo @VISO-3236 @VISOR_PILOTO
  ...
  @ResetVozNumeroSuspendido @VISO-3236 @VISOR_PILOTO
